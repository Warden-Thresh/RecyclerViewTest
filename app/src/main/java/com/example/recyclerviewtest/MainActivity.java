...
public class MainActivity extends AppCompatActivity {
    ...
    private void initFruits() {
        for (int i = 0; i < 10; i++) {
            ...
            Fruit watermelon = new Fruit(getRandomLenthName("Watermelon"), R.drawable.watermelon_pic);
            ...
            fruitList.add(grape);
            Fruit pineapple = new Fruit(getRandomLenthName("Pineapple"), R.drawable.pineapple_pic);
            fruitList.add(pineapple);
            Fruit strawberry = new Fruit(getRandomLenthName("Strawberry"), R.drawable.strawberry_pic);
